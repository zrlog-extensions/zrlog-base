...
public class TemplateInfoHelper {
    ...
    private static final List<String> CLASS_PATH_TEMPLATES = Arrays.asList(DEFAULT_TEMPLATE_PATH, TEMPLATE_BASE_PATH + "hexo-theme-fluid");
    ...
    public static TemplateVO loadTemplateVO(String templateName) {
        ...
        try {
            return getTemplateVO(PathUtil.getStaticFile(templateName));
        } catch (IOException e) {
    ...
    public static TemplateVO getByPackageJson(String templatePath, InputStream inputStream) {
    ...
    public static TemplateVO getByProperties(String templatePath, InputStream inputStream) {
        if (Objects.isNull(inputStream)) {
            return null;
        }
        try (InputStream in = new BufferedInputStream(inputStream)) {
